...
create table `ebook` (
  ...
  `category1_id` bigint comment 'class1',
  `category2_id` bigint comment 'class2',
...
insert into `ebook` (id, name, description) values (1, 'Spring Boot guide lessons', 'Java development，the best framework for enterprise applications');
insert into `ebook` (id, name, description) values (2, 'Vue guide lessons', 'Vue development，the best framework for enterprise applications');
insert into `ebook` (id, name, description) values (3, 'Python guide lessons', 'Python development，the best framework for enterprise applications');
insert into `ebook` (id, name, description) values (4, 'Mysql guide lessons', 'Mysql development，the best framework for enterprise applications');
insert into `ebook` (id, name, description) values (5, 'Oracle guide lessons', 'Oracle development，the best framework for enterprise applications');
